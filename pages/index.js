  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-4">
        <div className="flex flex-col justify-center pl-20 mt-10">
          <div className="">
      ...
      <div className="container mx-auto grid lg:grid-cols-3 md:grid-cols-1 gap-10 m-10">
        <div className="flex flex-col  items-center text-center">
          ...
          <span className="px-10 text-base text-gray-400 font-light">
      ...
      <div className="bg-sky-50">
        ...
        <div className="bg-white grid lg:grid-cols-2 md:grid-cols-1 place-content-center">
          ...
          <div className="flex flex-col justify-center max-w-md pl-20 ">
      ...
      <div className="m-10">
        <div className="grid place-content-center h-64">
          <div className="flex flex-col justify-center text-center max-w-md">
            <h1 className="text-5xl font-bold py-5">Proyectos innovadores</h1>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-1 mx-5">
          {/*Conectica */}
