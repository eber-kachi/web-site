...
const defaultMeta = {
  title: 'InittSoft Bolivia',
  siteName: 'Initt Software',
  description:
    'Somos una empresa de tecnologias y comunicación que desarrolla servicios basados en el uso de IA',
...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/* Windows 8 app icon */}
      <meta name="msapplication-TileColor" content="#0096c7" />
      <meta
