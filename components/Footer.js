            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
              ...
              <div>
                ...
                <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                  <a
                    href="https://api.whatsapp.com/send?phone=59167844094&text=Hola%20*InittSoft*%20%2C%20deseo%20consultar%20acerca%20de%20sus%20servicios%20"
                    className=""
                  >
                    +591 67844094
                  </a>
