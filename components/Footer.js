          ...
          <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
              <div className="px-6">
                ...
                <div className="flex mt-4 -mx-2">
                  ...
                  <a
                      href="https://www.facebook.com/InittSoftware"
                      className="mx-2 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400"
                      aria-label="Facebook"
                  >
                    <svg
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                <div>
                  <h3 className="text-gray-700 uppercase dark:text-white">Empresa</h3>
                  <a href="javascript:void(0);"
                      className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                  >Acerca de nosotros</a>
                </div>
                <div>
                  <h3 className="text-gray-700 uppercase dark:text-white">Servicios</h3>
                ...
                <div>
                  ...
                  <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">
                    <a href="https://api.whatsapp.com/send?phone=59167844094&text=Hola%20*InittSoft*%20%2C%20deseo%20consultar%20acerca%20de%20sus%20servicios%20" className="">+591 67844094</a>
                  </span>
                  <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">info@inittsoft.com</span>
                </div>
              </div>
            </div>
          </div>
